...
\markright{Ch. \ref{ch:what_is_logic}: What Is Logic?}
...
\conclusion{$\therefore$ The correct answer is C.}
\end{kormanize}
...
\begin{enumerate}[label=(\Alph*)]
	...
	\item \label{itm:silly}Abraham Lincoln is the king of Jupiter.
