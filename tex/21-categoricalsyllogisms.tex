...
\centering
\includegraphics[width=0.8\textwidth]{3venn7}
...
\centering
\includegraphics[width=0.8\textwidth]{3venn8}
...
\begin{marginfigure}
\includegraphics[width=0.8\textwidth]{3venn4}
...
\begin{marginfigure}
\includegraphics[width=0.8\textwidth]{3venn9}
\caption{The X is forced into region 3 because we know that nothing can be in region 4.}
...
\includegraphics[width=0.8\textwidth]{3venn2}
\caption{``All $M$ are $P$.''}
\label{fig:allmarep}
\end{marginfigure}
...
\includegraphics[width=0.8\textwidth]{3venn15}
...
\begin{marginfigure}
\includegraphics[width=0.8\textwidth]{3venn1}
\caption{``All $P$ are $M$.''}
\label{fig:allparem}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=0.8\textwidth]{3venn16}
...
\begin{marginfigure}
\includegraphics[width=0.8\textwidth]{3venn3}
\caption{``All $S$ are $M$.''}
...
\includegraphics[width=0.8\textwidth]{3venn17}
