...
\item If it is raining heavily, then you should take an umbrella.
\itemc So, you should take an umbrella.
\end{earg*}
...
\item Most people who read this book are logic students.
\itemc You are a logic student.
\end{earg*}
...
\begin{earg*}
\item You are reading this book.
\item At least one person reading this book is a professional surfer.
\itemc You are a professional surfer.
\end{earg*}
...
In logic, we are mostly concerned with evaluating the quality of inferences, not the truth of the premises. The truth of various premises will be a matter of whatever specific topic we are arguing aboutand since logic is content neutral we will also remain neutral.
