...
\input{tex/glossaries/20-categoricalstatements-gloss.tex}
...
\includegraphics[width=0.5\textwidth]{2venn1}
...
\begin{figure}[!ht]\centering
\includegraphics[width=0.5\textwidth]{2venn2}
...
\begin{figure}[!ht]\centering
\includegraphics[width=0.5\textwidth]{2venn5}
...
\begin{multicols}{2}\centering
    ...
    & \\
    & \\
    \multicolumn{2}{c}{\bf Translation Key} \\ \midrule
    S: & Dogs \\
