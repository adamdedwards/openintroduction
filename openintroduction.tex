\documentclass[nobib,twoside]{tufte-book}
\usepackage{packages/logicbook}
\addbibresource{tex/openlogic.bib}
...
\part{Categorical Logic}\label{part:cat_logic}
    ...
    \include{tex/24-transformations}
    \include{tex/21-categoricalsyllogisms}
    \include{tex/23-existentialimport}
    \include{tex/22-squareofopposition}
