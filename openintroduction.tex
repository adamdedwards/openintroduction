...
%General packages
\usepackage{answers,textcomp,float,anyfontsize}
\usepackage{url,syntonly,turnstile}
\usepackage[normalem]{ulem}
\usepackage{fixltx2e,wasysym,fancyref,etoolbox}
\usepackage{csquotes}
\usepackage{packages/logicbook} % Slowly moving everything into a single package for the book, as needed.
...
\frontmatter
\pagestyle{empty}
\include{tex/00-cover}
\include{tex/01-frontmatter}

\begin{fullwidth}\tableofcontents\end{fullwidth}
...
\include{tex/51-informalfallacies}
\include{tex/52-cognitivebiases}
...
\include{tex/61-induction}
\include{tex/62-millsmethods}
...
%\include{tex/70-introsettheory}
%\include{tex/71-relations}
%\include{tex/72-size}
%\include{tex/73-algebra}
%\include{tex/74-axiomofchoice}

%\part{Probability Theory}\label{part:probability}
%\include{tex/80-introprobability}
%\include{tex/81-conditionalprob}
%\include{tex/82-bayes}
%\include{tex/83-randomvariables}
